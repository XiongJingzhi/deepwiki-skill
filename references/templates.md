...
6. [快速开始骨架](#快速开始骨架)
7. [文档地图骨架](#文档地图骨架)
8. [menu.json 模板](#menujson-模板)
9. [源码追溯要求](#源码追溯要求)
10. [Mermaid 规范](#mermaid-规范)
...
[overview 组件：项目介绍、解决的挑战、典型用例]

---

## 架构预览

[architecture-diagram 组件：简化的架构图]

> 完整架构见 [架构文档](architecture.md)
...
[overview 组件：项目定位、架构风格、技术选型概述]

---

## 系统架构图

[architecture-diagram 组件：flowchart TB 展示分层架构]
...
[对每个模块：名称 + 链接、职责、核心接口、依赖关系]

---

## 数据流（条件：项目涉及 API 调用或跨组件数据传递）

[sequence-diagram 组件：展示典型场景的数据流]
...
[file-structure 组件：目录树 + 职责说明]

---

## 设计模式（条件：项目使用了设计模式）

[decision-table 组件或文字说明]
